...
const BannersTransactions = ({ showServiceTrans, triggerPageApi }) => {
                        ...
                        <Table aria-label="Banners Report" stickyHeader>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold' }} nowrap>Banner Category</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold' }} nowrap>banner Used For</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold' }} nowrap>BannersTitle</StyledTableCell>
