        ...
        <Toolbar>
          ...
          <Box display={"flex"} justifyContent={"space-between"} alignItems={"center"} width={"100%"}>
            ...
            <Box display={"flex"} justifyContent={"flex-end"} alignItems={"center"} >
              <Box border={"1px solid #D8D8D8"} borderRadius={"100px"} display={"flex"} justifyContent={"start"} alignItems={"center"} px={"9px"} py={"5px"}>
                <Box mr={1}>
              ...
              <Box border={"1px solid #D8D8D8"} mx={2} borderRadius={"100px"} display={"flex"} justifyContent={"start"} alignItems={"center"} px={"9px"} py={"5px"}>
                <Box mr={1}>
                  <InboxIcon style={{ color: "grey", fontSize: "20px" }} />
