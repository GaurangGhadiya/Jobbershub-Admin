                        ...
                        <Table aria-label="User Details" sx={{ size: 2 }} mt={2} stickyHeader>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Consumer Name</StyledTableCell>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Biller Id</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Bill Fetch Amount</StyledTableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                {showServiceTrans.length > 0 ? (rowsPerPage > 0
                                    ...
                                    >
                                        ...
                                        <StyledTableCell>{row.consumer_name}</StyledTableCell>
                                        ...
                                        <StyledTableCell>{row.biller_id}</StyledTableCell>
                                        <StyledTableCell>{row.bill_amount}</StyledTableCell>
                                    </StyledTableRow >
                                )) : (
