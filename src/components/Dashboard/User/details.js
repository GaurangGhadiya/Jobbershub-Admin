...
const Transactions = ({ showServiceTrans, totalPageCount, page, setPage, triggerPageApi }) => {
    let rows;
                        ...
                        <Table aria-label="User Details" sx={{ size: 2 }} mt={2} stickyHeader>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Authorize User</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Authorization Date</StyledTableCell>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Kyc Status</StyledTableCell>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Prime Affiliate</StyledTableCell>
...
{/* 
                                        ...
                                        <StyledTableCell style={{ color:row.user_status === 'Active' ? 'Green' : row.user_status === 'Inactive' ? 'Red' : 'Orange'  }} > {row.user_status === 'Active' ? 'Authorized' : (row.user_status === 'Inactive' ? 'Unauthorized': 'Free') }</StyledTableCell>
                                        ...
                                        <StyledTableCell style={{ color:row.kyc_status === 'Done' ? 'Green' :  'Orange'  }}>{row.kyc_status}</StyledTableCell>
                                        <StyledTableCell>
                                        ...
                                        <StyledTableCell style={{ color:row.affiliate_signature !==null ? 'Green' :  'Orange'  }} > {row.affiliate_signature !==null ? 'Done' : 'Pending' }</StyledTableCell>
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={25} component="th" scope="row">
