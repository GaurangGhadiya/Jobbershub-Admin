    ...
    const StyledTableCell = styled(TableCell)(({ theme }) => ({
      ...
      const handleOKButtonClick = async () => {
        ...
        try {
            ...
            const response = await api.post("/api/affiliate_link/update-category-status", requestData);
                        ...
                        <Table aria-label="User Details" sx={{ size: 2 }} mt={2} stickyHeader>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap', width:'70%' }} >Category Name</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap', width:'15%' }} >Category Image</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap', width:'15%' }} >Status</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap', width:'10%' }} >Action</StyledTableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                {showServiceTrans.length > 0 ? (rowsPerPage > 0
                                    ...
                                    >
                                       ...
                                       <StyledTableCell style={{ color:row.status === 1 ? 'Green' : row.status === 2 ? 'Red' : 'Orange' }} > {row.status === 1 ? 'Active' : row.status === 2 ? 'Inactive' : 'Deleted'}</StyledTableCell>
                                        <StyledTableCell sx={{ '& button': { m: 1 } }}>
                                                ...
                                                <Select
                                                    ...
                                                    >
                                                        ...
                                                        <MenuItem value="edit"><Link href={`/edit-affiliate-category/?id=${row.id}`} style={{'text-decoration': 'none'}}>Edit</Link></MenuItem>
