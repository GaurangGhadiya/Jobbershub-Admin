...
const FeedbackTransactions = ({ showServiceTrans }) => {
    ...
    const handleOpenModal1 = (Id,status) => {
      ...
      const handleHoldReasonChange = (event) => {
                        ...
                        <Table aria-label="Otp Report" stickyHeader>
                            ...
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold' }} nowrap>Admin Response</StyledTableCell>
                            ...
                            <TableBody>
                                ...
                                {showServiceTrans.length > 0 ? (rowsPerPage > 0
                                    ...
                                    >
                                        ...
                                        <StyledTableCell style={{ color:row.status === 1 ? 'Green' : row.status === 2 ? 'Blue' :
                                                         row.status === 3 ? 'Black' : 'Orange' }} > 
                                        ...
                                        <StyledTableCell>{row.admin_response}</StyledTableCell>
                                        ...
                                        {row.status === 0 ? null : (
                                                ...
                                                {row.status === 2 && (
                                                    ...
                                                    <Button variant="contained" size="small" color="warning" onClick={() => handleOpenModal2(row.id, 3)}>
                                                        Hold
                                                    </Button>
                                                    </>
                                                )}
                                            ...
                                            <Modal 
                                                ...
                                                >
                                                    ...
                                                    <TextareaAutosize 
                                                        ...
                                                        style={{ width: 400}} 
                                                        value={holdReason}
                                                        onBlur={handleDeleteReasonChange}
                                                    />
                                                    <Typography id="modal-modal-description" sx={{ mt: 2 }}  alignItems={'center'} >
                                                        <Button variant="contained" size="large" color="success" onClick={handleOKButtonClick} sx={{ marginLeft: 12, marginLeft:20 }}>OK</Button>
