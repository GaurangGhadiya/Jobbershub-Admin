            ...
            >
                <Grid item={true} xs={12}   >
                    ...
                    <TableContainer component={Paper} className="table_container">
                        ...
                        <Divider />
                        <Table aria-label="role" sx={{ size: 2 }} mt={2} stickyHeader>
                            <TableHead>
                                <TableRow>
                                    ...
                                    >
                                       ...
                                       <StyledTableCell sx={{ '& button': { m: 1 } }}>
                                                ...
                                                <Select
                                                        ...
                                                        style={{'width': '100px'}}
                                                    >
                                                        <MenuItem value="active"><Link style={{'text-decoration': 'none'}} onClick={() => handleOpenModal1(row.id, row.role_name, 1)}>Active</Link></MenuItem>
                                                        <MenuItem value="inactive"><Link style={{'text-decoration': 'none'}} onClick={() => handleOpenModal1(row.id, row.role_name, 0)}>Inactive</Link></MenuItem>
                                                        <MenuItem value="edit"><Link href={`/edit-role/?id=${row.id}`} style={{'text-decoration': 'none'}}>Edit</Link></MenuItem>
