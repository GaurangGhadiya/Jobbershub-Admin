    ...
    const StyledTableCell = styled(TableCell)(({ theme }) => ({
      ...
      const handleOKButtonClick = async () => {
        ...
        try {
            ...
            const response = await api.post("/api/log/update-donation-service-status", requestData);
                        ...
                        <Table aria-label="User Details" sx={{ size: 2 }} mt={2} stickyHeader>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap', width:'70%' }} >Service Name</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap', width:'15%' }} >Service Image</StyledTableCell>
                            ...
                            <TableBody>
                                {showServiceTrans.length > 0 ? (rowsPerPage > 0
                                    ...
                                    >
                                        ...
                                        <StyledTableCell> {row.image_url !== '' ? (
                                            <Link href="#" onClick={() => handleLinkClick(row.image_url)}>
                                                View Image
                                            </Link>
                                        ) : (
                                            ''
                                        ...
                                        <StyledTableCell sx={{ '& button': { m: 1 } }}>
                                                ...
                                                <Select
                                                    ...
                                                    >
                                                        ...
                                                        <MenuItem value="edit"><Link href={`/edit-donation-services/?id=${row.id}`} style={{'text-decoration': 'none'}}>Edit</Link></MenuItem>
