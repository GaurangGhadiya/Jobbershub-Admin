...
import UpdateQualification from '@/components/userManagement/update-qualification'; 
                        ...
                        <Table aria-label="User Details" sx={{ size: 2 }} mt={2}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} width="90%">Qualification Name</StyledTableCell>
                            ...
                            <TableBody>
                                {showServiceTrans.length > 0 ? (rowsPerPage > 0
                                    ...
                                    >
                                        ...
                                        <StyledTableCell>{row.qualification_name}</StyledTableCell>
