...
const ViewEmployeeTransactions = () => {
            ...
            <Grid item={true} xs={12}   >
                <TableContainer component={Paper} >
                    ...
                    <Box display={'inline-block'} justifyContent={'space-between'} alignItems={'right'} mt={1} mb={1} style={{width: '30%', verticalAlign: 'top'}} >
                        <Typography variant="h5"  sx={{ padding: 2 }}>All Affiliate Dashboard</Typography>
                    </Box>
                    <Box sx={{ width: '100%' }}>
    ...
    <TableHead>
        <TableRow sx={{ backgroundColor: "#f7f5dd" }}>
            <TableCell sx={{ border: '1px solid #ccc' }}>Sl No.</TableCell>
            <TableCell sx={{ border: '1px solid #ccc' }}>Table Permission</TableCell>
            <TableCell sx={{ border: '1px solid #ccc' }}>Select</TableCell>
            <TableCell sx={{ border: '1px solid #ccc' }}>Special Customize Filter Permission</TableCell>
       
            <TableCell sx={{ border: '1px solid #ccc' }}>View</TableCell>
            <TableCell sx={{ border: '1px solid #ccc' }}>Create</TableCell>
            <TableCell sx={{ border: '1px solid #ccc' }}>Edit</TableCell>
            <TableCell sx={{ border: '1px solid #ccc' }}>Hide</TableCell>
        </TableRow>
    </TableHead>
    <TableBody>
        {menus.map((menu, index) => (
            <TableRow key={index}>
                ...
                <TableCell sx={{ border: '1px solid #ccc' }}>{menu.menu_name}</TableCell>
                <TableCell sx={{ border: '1px solid #ccc' }}>{menu.parent_menu}</TableCell>
                ...
                <TableCell sx={{ border: '1px solid #ccc' }}>
                    <FormControlLabel
                        control={<Checkbox checked={menu.create ? menu.create : editchecked[menu.id]} onChange={(event) => edithandleChange(event, menu.id, menu.menu_url)} />}
                    />
                </TableCell>
                <TableCell sx={{ border: '1px solid #ccc' }}>
                    <FormControlLabel
