import { Box, Button,Divider,TextField, Container, Grid, Paper, Table, TableBody,selectedRow, StyledTableCell, TableContainer, MenuItem, TableHead, TablePagination, TableRow, Typography, Link, IconButton } from "@mui/material";
import { useEffect, useState } from "react";
import * as React from 'react';
import TableCell, { tableCellClasses } from '@mui/material/TableCell';
import { styled } from '@mui/material/styles';
import UpdateDepartment from '@/components/userManagement/update-department';
                        ...
                        <Table aria-label="User Details" sx={{ size: 2 }} mt={2}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} width="90%">Department Name</StyledTableCell>                                    
