                        ...
                        <Table aria-label="User Details" sx={{ size: 2 }} mt={2}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Service Active Income Rate</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Service Passive Income Rate</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Main Actve Income Rate</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Main Passive Income Rate</StyledTableCell>
                            ...
                            <TableBody>
                                {showServiceTrans.length > 0 ? (rowsPerPage > 0
                                    ...
                                    >
                                        ...
                                        <StyledTableCell>{row.service_active_income_rate}</StyledTableCell>
                                        <StyledTableCell>{row.service_passive_income_rate}</StyledTableCell>
                                        <StyledTableCell>{row.main_actve_income_rate}</StyledTableCell>
                                        <StyledTableCell>{row.main_passive_income_rate}</StyledTableCell>
