    ...
    const StyledTableCell = styled(TableCell)(({ theme }) => ({
      ...
      const handleOKButtonClick = async () => {
        ...
        try {
            ...
            const response = await api.post("/api/course_video/update-status-category", requestData);
                                       ...
                                       <StyledTableCell sx={{ '& button': { m: 1 } }}>
                                                <Select
                                                    ...
                                                    >
                                                        ...
                                                        <MenuItem value="edit"><Link href={`/edit-marketing-video-category/?id=${row.id}`} style={{'text-decoration': 'none'}}>Edit</Link></MenuItem>
