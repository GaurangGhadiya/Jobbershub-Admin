import { Box, Button,Divider,Modal, Grid, Paper, Table, TableBody, StyledTableCell, TableContainer, TableHead, TablePagination, TableRow, Typography, Link } from "@mui/material";
                        ...
                        <Table aria-label="User Details" sx={{ size: 2 }} mt={2} stickyHeader>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >lead Field Label</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Image</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }} >Specification</StyledTableCell>
                            ...
                            <TableBody>
                                {filteredRows.length > 0 ? (rowsPerPage > 0
                                    ...
                                    >
                                        ...
                                        <StyledTableCell>{row.lead_field_lebel}</StyledTableCell>
                                        ...
                                        <StyledTableCell sx={{ '& button': { m: 1 } }}>
                                            <Link href={`/add-new-lead/?action=update&lead_id=${row.id}&category_id=${row.category_id}`}>
                                            <a>
                                                <Button variant="contained" size="small" color="warning" style={{ fontWeight: 'bold' }}>Edit</Button>
                                            </a>
                                            </Link>
