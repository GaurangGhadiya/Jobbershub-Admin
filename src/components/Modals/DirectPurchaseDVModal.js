...
export default function DirectPurchaseDVModal({ directPurchaseDV, directPurchaseDVClose }) {
    ...
    return (
        <React.Fragment>
            ...
            <BootstrapDialog
                onClose={directPurchaseDVClose}
                // aria-labelledby="customized-dialog-title"
                open={directPurchaseDV}
                // fullWidth={true}
                // maxWidth={'xxs'}
            >
                ...
                <DialogContent>
                   ...
                   <Box display={"flex"} justifyContent={"space-between"} mt={2}>
                    ...
                    <Box width={"100%"} display={"flex"} justifyContent={"space-around"} mt={4}>
                        <Box style={{ cursor: "pointer", padding: "11px 29px", border: "2px solid #FF9F59" }} borderRadius={"4px"} width={"70px"} mr={1} onClick={directPurchaseDVClose}>
                            <Typography color={"#FF9F59"} fontSize={"18px"} textAlign={"center"} fontWeight={500}>Reset</Typography>
                        </Box>
                        <Box style={{ cursor: "pointer", padding: "11px 29px", backgroundColor: "#FF9F59" }} borderRadius={"4px"} width={"70px"} ml={1} onClick={directPurchaseDVClose}>
