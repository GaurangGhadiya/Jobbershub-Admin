...
export default function ChildHigherEducationFundModal({ childHigherEducationFund, childHigherEducationFundClose }) {
            ...
            >
                ...
                <DialogContent>
                    ...
                    <Box width={"100%"} display={"flex"} justifyContent={"center"} mt={3}>
                        <Box style={{ cursor: "pointer", padding: "11px 29px", border: "2px solid #FF9F59" }} borderRadius={"4px"} width={"70px"} mr={1} onClick={childHigherEducationFundClose}>
                            <Typography color={"#FF9F59"} fontSize={"18px"} textAlign={"center"} fontWeight={500}>Reset</Typography>
                        </Box>
                        <Box style={{ cursor: "pointer", padding: "11px 29px", backgroundColor: "#FF9F59" }} borderRadius={"4px"} width={"122px"} onClick={childHigherEducationFundClose}>
