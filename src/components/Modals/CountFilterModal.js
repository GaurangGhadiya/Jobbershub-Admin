...
export default function CountFilterModalModal({ filterData,setFilterData, countFilterModal, countFilterModalClose }) {
    ...
    return (
        <React.Fragment>
            {countFilterModal == true &&
                <ClickAwayListener onClickAway={countFilterModalClose}>
                    <Box boxShadow={"0px 4px 6px rgba(0, 0, 0, 0.2)"} zIndex={11} top={35} right={0} backgroundColor="white" border={"1px solid #CDCDCD"} p={2} borderRadius={"4px"} position={"absolute"} width={400} >
