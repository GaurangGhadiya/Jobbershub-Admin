...
export default function MainPassiveIncomeModal({filterData,setFilterData, mainPassiveIncome, mainPassiveIncomeClose }) {
    ...
    return (
        <React.Fragment>
            ...
            {/* <BootstrapDialog
                onClose={mainPassiveIncomeClose}
                open={pendingLeads}
            > */}


            {mainPassiveIncome && <ClickAwayListener onClickAway={mainPassiveIncomeClose}>
                ...
                <Box width={"100%"} display={"flex"} justifyContent={"end"} mt={4}>
                    <Box style={{ cursor: "pointer", padding: "7px 19px", border: "2px solid #FF9F59" }} borderRadius={"4px"} width={"120px"} mr={1} onClick={mainPassiveIncomeClose}>
                        <Typography color={"#FF9F59"} fontSize={"18px"} textAlign={"center"} fontWeight={500}>Reset</Typography>
                    </Box>
                    <Box style={{ cursor: "pointer", padding: "7px 19px", backgroundColor: "#FF9F59" }} borderRadius={"4px"} width={"120px"} ml={1} onClick={mainPassiveIncomeClose}>
