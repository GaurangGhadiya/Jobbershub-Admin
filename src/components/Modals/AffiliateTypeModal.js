...
export default function AffiliateTypeModal({ affiliateType, affiliateTypeClose }) {
                ...
                <DialogContent>
                    ...
                    <Box display={"flex"} justifyContent={"space-between"} px={2}>
                        <Box>
                                ...
                                <Typography mt={2.5}>Prime</Typography>
                                <Typography mt={2.5}>Normal</Typography>
                        </Box>
                        <FormControl>
                        <RadioGroup
                            // row
                    ...
                    <Box width={"100%"} display={"flex"} justifyContent={"space-around"} mt={4}>
                        <Box style={{ cursor: "pointer", padding: "11px 29px", border: "2px solid #FF9F59" }} borderRadius={"4px"} width={"70px"} mr={1} onClick={affiliateTypeClose}>
                            <Typography color={"#FF9F59"} fontSize={"18px"} textAlign={"center"} fontWeight={500}>Reset</Typography>
                        </Box>
                        <Box style={{ cursor: "pointer", padding: "11px 29px", backgroundColor: "#FF9F59" }} borderRadius={"4px"} width={"70px"} ml={1} onClick={affiliateTypeClose}>
