                ...
                <Table stickyHeader style={{ tableLayout: 'fixed', width: '100%', backgroundColor : "white" }}>
                    <TableHead >
                        <TableRow>
                            ...
                            {afterSubmitSelectedRow?.AffiliateName && <TableCell style={{ position: 'sticky', left: 445, backgroundColor: '#fff', zIndex: 10, width: 130 }}>Seller Mobile Number</TableCell>}


                            {afterSubmitSelectedRow?.State && <TableCell width={150} >Email ID</TableCell>}
                            ...
                            {afterSubmitSelectedRow?.AffiliateMobileNo && <TableCell width={150}>Sub Category</TableCell>}
                            {afterSubmitSelectedRow?.EmailID && <TableCell width={150}>Course</TableCell>}
                            {afterSubmitSelectedRow?.SponsorType && <TableCell width={150}>Description</TableCell>}
                            ...
                            {afterSubmitSelectedRow?.ViewUplineList && <TableCell width={110}>Action</TableCell>}
                    ...
                    <TableBody>
                        {rows.map((row) => (
                            <TableRow
                                ...
                                {afterSubmitSelectedRow?.AffiliateName && <TableCell align="center" style={{ position: 'sticky', left: 445, backgroundColor: '#fff', zIndex: 9 }}>Ramesh Jadhav</TableCell>}
