    ...
    <>
      ...
      <label htmlFor="file-upload" style={{ width: "250px", display: "block", position: "relative" }}>
        {!formData?.offer_poster ? <IconWrapper>
          ...
          <IconWrapper >
            {formData?.offer_poster && <Image 
            src={formData?.offer_poster instanceof File ?  URL.createObjectURL(formData?.offer_poster) : formData?.offer_poster ?process.env.NEXT_PUBLIC_PHOTO_BASE_URL + "/course/" + formData?.offer_poster : null} width={250} height={145} 
            style={{ height: "145px", marginTop: "-30px", padding: "5px" }} />}
