...
import Transactions from "@/components/Dashboard/User/additionalDetails";
...
function TransactionHistory(props) {
    ...
    useEffect(() => {
        const getTnx = async () => {
          ...
          try {
            const response = await api.post('/api/report/user-additional-details', reqData);
              ...
              <Grid item={true} xs={12}   >
                  <Grid className="page-header" item xs={12}>
                      <Grid container spacing={1}>
                          <Grid item xs={10}>
                              <Typography variant="h5">User Additional Details</Typography>
                          </Grid>
                      </Grid>
                  </Grid>
                  <Grid container spacing={1}>
