...
function AffiliateHistory(props) {
            ...
            <Grid item={true} xs={12}   >
              <TableContainer component={Paper} >
                ...
                <Box display={'inline-block'} justifyContent={'space-between'} alignItems={'right'} mt={1} mb={1} style={{width: '20%', verticalAlign: 'top'}} >
                    <Typography variant="h5"  sx={{ padding: 2 }}>Affiliate Link List</Typography>
                </Box>
                ...
                <Box display={'inline-block'} justifyContent={'space-between'} alignItems={'center'}  mt={2} sx={{width: '20%',verticalAlign: 'top' }} >
                            <Button variant="contained" href={`/add-new-affiliate-link/`}>
                               AddNew Affiliate Link
                            </Button>
                    </Box>
              </TableContainer>
            </Grid>
