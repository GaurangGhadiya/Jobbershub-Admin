...
function MeetingDetailsReport(props) {
    ...
    const handleChangeEvent = async () => {
        ...
        const newFromDate1 = fromDate.add(1, 'day');
        const reqData1 = {
            from_date: newFromDate1.toISOString().split('T')[0],
            to_date: toDate.toISOString().split('T')[0],
        ...
        try {
            ...
            const response = await api.post('/api/meeting/meeting-user-enrollment-details', reqData1);
    ...
    const handleFromDateChange = (date) => {
      ...
      const handleToDateChange = (date) => {
        ...
        // Excel export 
        const [fileName, setFileName] = useState('meeting-enroll-report.xlsx');
    ...
    return (
        ...
        <Layout>
                ...
                <Grid item={true} xs={12}   >
                    <Grid className="page-header" item xs={12}>
                        <Grid container spacing={1}>
                            <Grid item xs={10}>
                                <Typography variant="h5"  >Meeting Enroll Report</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                    <Grid container spacing={1}>
                            ...
                            <Box mt={1} mb={1} sx={{width: '100%'}} >
                                <FormControl fullWidth >
                                    ...
                                    >
                                        ...
                                        <MenuItem value="is_join">Join</MenuItem>
                                        <MenuItem value="is_enroll">Enroll</MenuItem>
                                        <MenuItem value="is_invite ">Invite</MenuItem>
                                    </Select>
                                </FormControl>
                            </Box>
                        </Grid>
                    ...
                    <Grid item={true} xs={12} >
                        <Box display={'inline-block'} justifyContent={'space-between'} alignItems={'center'} mt={1} mb={1} sx={{ verticalAlign: 'middle', float:'right'}}>
            ...
            <MeetingDetailsTransactions showServiceTrans={showServiceTrans} exportToExcel={exportToExcel} />
        </Layout>
