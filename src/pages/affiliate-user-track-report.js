...
function AffiliateTrackDetailsHistory(props) {
    ...
    useEffect(() => {
        const getTnx = async () => {
          ...
          try {
            const response = await api.post('/api/affiliate_link/get-affiliate-user-track-report', reqData);
        ...
        <Layout>
            ...
            <Grid item={true} xs={12}   >
              <TableContainer component={Paper} >
                ...
                <Box display={'inline-block'} justifyContent={'space-between'} alignItems={'right'} mt={1} mb={1} style={{width: '45%', verticalAlign: 'top'}} >
                    <Typography variant="h5"  sx={{ padding: 2 }}>Affiliate User Track Details Report</Typography>
                </Box>
