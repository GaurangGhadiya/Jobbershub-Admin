...
import Transactions from "@/components/userManagement/department";
...
import AddVendorForm from '@/components/userManagement/add-department'; 
...
const TransactionHistory = (props) => {
  ...
  useEffect(() => {
      const getTnx = async () => {
          const reqData = {};
          try {
              const response = await api.get('/api/employee/get-department-list', reqData);
